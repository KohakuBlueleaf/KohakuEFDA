...
| `scenario_wuling_battery50.toml` | Recorded player SC Wuling Battery minimum-target scenario in the level-3 Cardiac Remediation Station; retains the supplied material policy |
