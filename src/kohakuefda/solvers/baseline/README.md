...
| File | Provides |
|---|---|
| `__init__.py` | Baseline strategy, validated defaults and declared parallel capability |
...
| `parallel.py` | Seeded batches with live labeled worker frames; selected snapshots imported without replay |
